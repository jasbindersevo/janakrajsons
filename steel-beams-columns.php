<?php include('header.php');?>
  ...
  <!-- page-title -->
  <section class="page-title shop-single" style="background-image: url(images/steel-beams-1.jpg);">
        <div class="container">
            <div class="content-box">
                <h1>Steel Beams and Columns</h1>
            </div>
        </div>
    </section>
    <!-- page-title end -->
            ...
            <div class="products-details">
                <div class="row">
                        ...
                        <div class="carousel-content">
                            <div class="carousel-outer" data-wow-delay="0ms">
                                <ul class="image-carousel owl-carousel owl-theme">
                                    <li><a href="images/resource/shop/shop-single.jpg" class="lightbox-image" data-fancybox="gallery"><img src="images/resource/shop/steel-beams1.jpg" alt=""></a></li>
                                    <li><a href="images/resource/shop/shop-single-2.jpg" class="lightbox-image" data-fancybox="gallery"><img src="images/resource/shop/steel-beams2.jpg" alt=""></a></li>

                                    <li><a href="images/resource/shop/shop-single-2.jpg" class="lightbox-image" data-fancybox="gallery"><img src="images/resource/shop/steel-beams3.jpg" alt=""></a></li>
                                    <li><a href="images/resource/shop/shop-single-3.jpg" class="lightbox-image" data-fancybox="gallery"><img src="images/resource/shop/steel-beams1.jpg" alt=""></a></li>
                                    <li><a href="images/resource/shop/shop-single.jpg" class="lightbox-image" data-fancybox="gallery"><img src="images/resource/shop/steel-beams2.jpg" alt=""></a></li>
                                    
                                    <li><a href="images/resource/shop/shop-single-3.jpg" class="lightbox-image" data-fancybox="gallery"><img src="images/resource/shop/steel-beams3.jpg" alt=""></a></li>
                                </ul>
                                
                                <ul class="thumbs-carousel owl-carousel owl-theme centred">
                                    <li><img src="images/resource/shop/steel-beams1-thumb.jpg" alt=""></li>
                                    <li><img src="images/resource/shop/steel-beams2-thumb.jpg" alt=""></li>
                                    <li><img src="images/resource/shop/steel-beams3-thumb.jpg" alt=""></li>
                    ...
                    <div class="col-lg-5 col-md-12 col-sm-12 content-column">
                        <div class="content-box">
                            <h3 class="product-price">Best Steel Beams and Columns <br> in Ludhiana</h3>
                    ...
                    <div class="tabs-content">
                            ...
                            <div class="inner-box">
                                ...
                                <div class="lower-content">
                                    <div class="single-item">
                                        <figure class="image-box"><img src="images/resource/shop/steel-beams1.jpg" alt=""></figure>
                                    ...
                                    <div class="single-item">
                                        <figure class="image-box"><img src="images/resource/shop/steel-beams2jpg" alt=""></figure>
                        ...
                        <div class="tab clearfix" id="tab-2">
                            <div class="inner-box">
                                ...
                                <div class="lower-content">
                                    ...
                                    <div class="single-item">
                                        <figure class="image-box"><img src="images/resource/shop/steel-beams2.jpg" alt=""></figure>
                                        <h3>Precision Stone Polishing</h3>
                                        <ul>
                                            <li>Produce in 1 hour what it takes 5 hours to do by hand with the</li>
                                            <li>PRO-EDGE® IV Edge Polisher. This automatic edge shaper and polisher</li>
                        ...
                        <!-- <div class="tab clearfix" id="tab-3">
                            <div class="inner-box">
                                ...
                                <div class="lower-content">
                                    <div class="single-item">
                                        <figure class="image-box"><img src="images/resource/shop/shop-single-4.jpg" alt=""></figure>
                                        <h3>Features & Benefits</h3>
                                        <ul>
                                            <li>Production: 12 feet per hour</li>
                                            <li>Stores up to 70 repeatable Convex, Concave, and Ogee edge profiles</li>
                                    ...
                                    <div class="single-item">
                                        <figure class="image-box"><img src="images/resource/shop/shop-single-5.jpg" alt=""></figure>
                                        <h3>Precision Stone Polishing</h3>
                                        <ul>
                                            <li>Produce in 1 hour what it takes 5 hours to do by hand with the</li>
                                            <li>PRO-EDGE® IV Edge Polisher. This automatic edge shaper and polisher</li>
