<?php include('header.php');?>
  ...
  <!-- page-title -->
  <section class="page-title shop-single" style="background-image: url(images/steel-pipes.jpg);">
        <div class="container">
            <div class="content-box">
                <h1>Steel Tubes and Pipes</h1>
            </div>
        </div>
    </section>
    <!-- page-title end -->
            ...
            <div class="products-details">
                <div class="row">
                        ...
                        <div class="carousel-content">
                            <div class="carousel-outer" data-wow-delay="0ms">
                                <ul class="image-carousel owl-carousel owl-theme">
                                    <li><a href="images/resource/shop/shop-single.jpg" class="lightbox-image" data-fancybox="gallery"><img src="images/resource/shop/steel-pipes1.jpg" alt=""></a></li>
                                    <li><a href="images/resource/shop/shop-single-2.jpg" class="lightbox-image" data-fancybox="gallery"><img src="images/resource/shop/steel-pipes2.jpg" alt=""></a></li>
                                    <li><a href="images/resource/shop/shop-single-3.jpg" class="lightbox-image" data-fancybox="gallery"><img src="images/resource/shop/steel-pipes3.jpg" alt=""></a></li>
                                    <li><a href="images/resource/shop/shop-single.jpg" class="lightbox-image" data-fancybox="gallery"><img src="images/resource/shop/steel-pipes1.jpg" alt=""></a></li>
                                    <li><a href="images/resource/shop/shop-single-2.jpg" class="lightbox-image" data-fancybox="gallery"><img src="images/resource/shop/steel-pipes2.jpg" alt=""></a></li>
                                    <li><a href="images/resource/shop/shop-single-3.jpg" class="lightbox-image" data-fancybox="gallery"><img src="images/resource/shop/steel-pipes3.jpg" alt=""></a></li>
                                </ul>
                                ...
                                <ul class="thumbs-carousel owl-carousel owl-theme centred">
                                    <li><img src="images/resource/shop/steel-pipes1-thumb.jpg" alt=""></li>
                                    <li><img src="images/resource/shop/steel-pipes2-thumb.jpg" alt=""></li>
                                    <li><img src="images/resource/shop/steel-pipes3-thumb.jpg" alt=""></li>
                                    <li><img src="images/resource/shop/steel-pipes1-thumb.jpg" alt=""></li>
                                    <li><img src="images/resource/shop/steel-pipes2-thumb.jpg" alt=""></li>
                                    <li><img src="images/resource/shop/steel-pipes3-thumb.jpg" alt=""></li>
                                </ul>
                    ...
                    <div class="col-lg-5 col-md-12 col-sm-12 content-column">
                        <div class="content-box">
                            <h3 class="product-price">Best Steel Tubes and Pipes <br> in Ludhiana</h3>
                            ...
                            <div class="inner-box">
                                ...
                                <div class="lower-content">
                                    <div class="single-item">
                                        <figure class="image-box"><img src="images/resource/shop/steel-pipes1.jpg" alt=""></figure>
                                    ...
                                    <div class="single-item">
                                        <figure class="image-box"><img src="images/resource/shop/steel-pipes3.jpg" alt=""></figure>
